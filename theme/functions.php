...
?>
	...
	<div class="category-posts post-wrapper flex flex-col lg:mb-28 xl:mb-32 mr-0 <?php if (isset($attributes['showBrowseResources']) && $attributes['showBrowseResources']) {
																						echo 'has-browae-resources';
																					} ?>" id="post-wrapper">
	...
	<?php if (isset($attributes['showBrowseResources']) && $attributes['showBrowseResources']) : ?>
		<div class="browse-resources bg-purple-25 lg:w-[1200px] lg:rounded-[10px] lg:mt-16 lg:mb-28 xl:mb-32">
